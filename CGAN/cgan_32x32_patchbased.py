...
class CGAN():
    ...
    def load_data(self, stride, thresh):
        ...
        - y_train: labels.
        """
        x_train, y_train = load_patches("/data/line/OCT-patchbased-CGAN/generated_patches/32x32/training", stride, thresh)
...
if __name__ == '__main__':
    ...
    cgan = CGAN(filepath="/data/line/OCT-patchbased-CGAN/cgan_32x32_patchbased"+'/thresh='+ str(int(thresh*100))+"/s="+str(stride), replay=True, replay_start_record=5000, replay_start_substitution=6000, replay_interval=100,
